...
const translations = {
  es: {
    ...
    'hero-desc': 'Co-fundador de <a href="https://nuviadev.vercel.app" target="_blank" rel="noopener" class="nuviadev-link">NuviaDev</a>. Apasionado por crear experiencias digitales modernas, eficientes y visualmente impactantes. Estudiante de DAM en Igualada, Barcelona.',
    'hero-btn-projects': 'Ver proyectos',
    'stat-projects': 'Proyectos activos',
    'stat-company': 'Empresa fundada',
    'about-tag': 'Sobre mí',
    'about-title': 'Quién soy',
    'about-p1': 'Soy Derek Posadas Saucedo, desarrollador frontend y de software. Co-fundador de <a href="https://nuviadev.vercel.app" target="_blank" rel="noopener" class="nuviadev-link">NuviaDev</a>, una empresa creada junto a compañeros de DAM para ofrecer soluciones web modernas y personalizadas a clientes.',
    'about-p2': 'Actualmente cursando el Grado Superior de Desarrollo de Aplicaciones Multiplataforma (DAM), con una base sólida en sistemas y redes gracias a mis estudios previos de Sistemas Microinformáticos y Redes.',
  ...
  ca: {
    ...
    'hero-desc': 'Co-fundador de <a href="https://nuviadev.vercel.app" target="_blank" rel="noopener" class="nuviadev-link">NuviaDev</a>. Apassionat per crear experiències digitals modernes, eficients i visualment impactants. Estudiant de DAM a Igualada, Barcelona.',
    'hero-btn-projects': 'Veure projectes',
    'stat-projects': 'Projectes actius',
    'stat-company': 'Empresa fundada',
    'about-tag': 'Sobre mi',
    'about-title': 'Qui soc',
    'about-p1': 'Soc Derek Posadas Saucedo, desenvolupador frontend i de programari. Co-fundador de <a href="https://nuviadev.vercel.app" target="_blank" rel="noopener" class="nuviadev-link">NuviaDev</a>, una empresa creada amb companys de DAM per oferir solucions web modernes i personalitzades als clients.',
    'about-p2': 'Actualment cursant el Grau Superior de Desenvolupament d\'Aplicacions Multiplataforma (DAM), amb una base sòlida en sistemes i xarxes gràcies als meus estudis previs de Sistemes Microinformàtics y Xarxes.',
    ...
    'proj-more': 'Veure més',
    'proj1-type': 'Web Corporativa',
    'proj1-name': 'NuviaDev - Lloc Oficial',
    ...
    'proj2-name': 'GestorPro - Inventari',
    ...
    'proj3-name': 'TaskFlow - Gestor de Tasques',
  ...
  en: {
    ...
    'hero-desc': 'Co-founder of <a href="https://nuviadev.vercel.app" target="_blank" rel="noopener" class="nuviadev-link">NuviaDev</a>. Passionate about building modern, efficient, and visually impactful digital experiences. DAM student in Igualada, Barcelona.',
    'hero-btn-projects': 'View projects',
    'stat-projects': 'Active projects',
    'stat-company': 'Company founded',
    'about-tag': 'About me',
    'about-title': 'Who I am',
    'about-p1': 'I\'m Derek Posadas Saucedo, a frontend and software developer. Co-founder of <a href="https://nuviadev.vercel.app" target="_blank" rel="noopener" class="nuviadev-link">NuviaDev</a>, a company built alongside DAM classmates to deliver modern and tailored web solutions to clients.',
    'about-p2': 'Currently studying for a Higher Degree in Cross-Platform Application Development (DAM), with a solid foundation in systems and networking from my previous Microcomputer Systems and Networks studies.',
    ...
    'tl4-org': 'MSN – Intermediate Degree',
    ...
    'proj1-name': 'NuviaDev - Official Website',
    ...
    'proj2-name': 'GestorPro - Inventory',
    ...
    'proj3-name': 'TaskFlow - Task Manager',
